...
{% include team_member member_name="Susanna" bio="<strong>Susanna Kiwala</strong> is a Programmer Analyst at the McDonnell Genome Institute at Washington University in St. Louis. She obtained her M.eng in Computer Science from Southern Illinois University in Edwardsville. She is the lead software developer for the Clinical Interpretations of Variants in Cancer project (civicdb.org), the Drug Gene Interaction Database (dgidb.org), and pVACtools (https://github.com/griffithlab/pVAC-Tools)." image="/assets/img/team/susanna_kiwala.jpeg" role="Programmer Analyst" %}
